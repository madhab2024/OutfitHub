...
export const SignupPage = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    setMessage('Signup successful. Welcome to OutfitHub!')
    setLoading(false)
    setTimeout(() => {
      navigate('/login')
    }, 1500)
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#f0f2f5] p-4 font-sans">
      <div className="relative flex min-h-[650px] w-full max-w-[1000px] overflow-hidden rounded-[30px] bg-white shadow-2xl">
        
        {/* Left Side - Info (White) */}
        <div className="hidden w-1/2 flex-col items-center justify-center bg-white p-16 text-center md:flex">
          <div className="absolute -top-20 -left-20 h-64 w-64 rounded-full bg-blue-50"></div>
          
          <div className="relative z-10 max-w-xs">
            <h2 className="text-3xl font-black text-slate-900">Already a Member?</h2>
            <p className="mt-6 text-base leading-relaxed text-slate-500">
              Welcome back! If you already have an account, just sign in to pick up where you left off.
            </p>
            <button
        ...
        <div className="relative flex w-full flex-col justify-center bg-[#0066FF] px-8 py-12 text-white md:w-1/2 md:px-16">
          ...
          <div className="relative z-10">
            ...
            <p className="mt-4 text-sm font-light leading-relaxed text-blue-100">
              Join OutfitHub today and get early access to exclusive products, deals and more.
            </p>
            ...
            <form className="mt-10 flex flex-col gap-4" onSubmit={handleSubmit}>
              ...
              {message && (
                <div className="rounded-xl bg-emerald-500/10 px-4 py-2 text-sm text-emerald-100 backdrop-blur-sm">
                  {message}
                </div>
              )}
            ...
            <div className="mt-8 flex flex-col gap-4">
              <div className="flex items-center gap-4 text-blue-200">
                ...
                <span className="text-xs font-bold uppercase tracking-widest">Or Sign Up With</span>
                <div className="h-px flex-1 bg-white/20"></div>
              </div>
        ...
        <div className="flex items-center justify-center bg-[#0066FF] pb-10 md:hidden">
           <p className="text-sm text-blue-100">
              Already have an account? <Link to="/login" className="font-bold text-white underline">Sign in here</Link>
           </p>
        </div>
      </div>
    </div>
